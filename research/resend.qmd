...
# plot_html = f'<img src="cid:image/png;base64,{plot_base64}" alt="plotnine plot"/><br>'
...
# image_html = f'<img src="cid:image/jpeg;base64,{image_base64}" alt="placeholder image"/><br>'
